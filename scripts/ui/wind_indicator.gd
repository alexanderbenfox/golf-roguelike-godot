...
func _ready() -> void:
	...
	_arrow = Control.new()
	_arrow.custom_minimum_size = Vector2(40, 40)
	_arrow.size = Vector2(40, 40)
	_arrow.position = Vector2(22, 4)
	...
	_speed_label.position = Vector2(0, 48)
	_speed_label.size = Vector2(84, 20)
	...
	_dir_label.add_theme_font_size_override("font_size", 12)
	_dir_label.add_theme_color_override("font_color", Color(0.8, 0.8, 0.8, 0.7))
	_dir_label.position = Vector2(0, 66)
	_dir_label.size = Vector2(84, 16)
